...
namespace standard
{
	...
	bool is_mouse, is_left_handed, is_emoticonkeep,is_soundkeep,is_mouse_force_move;
	...
	bool init()
	{
		...
		hand_offset_x = data::cfg["decoration"]["hand_offset"][0].asInt();
		hand_offset_y = data::cfg["decoration"]["hand_offset"][1].asInt();
